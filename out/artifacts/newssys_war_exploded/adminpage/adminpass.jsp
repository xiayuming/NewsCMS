...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        ...
        <!--修改密码表单-->
        <form method="post" class="form-x" action="user_updatePassword.action">
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                       <s:property value="#session.admininfo.userId"/>
                        (<s:property value="#session.admininfo.userAuthority"/>)
                    </label>
                </div>
            </div>

            <input type="hidden" name="userId" value="<s:property value="#session.admininfo.userId" default="0"/>">
