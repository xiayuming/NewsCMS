        ...
        <table class="table table-hover text-center">
            ...
            <s:iterator value="list" var="s">
                <tr>
                    ...
                    <td><s:property value="#s.userPO.userName"/></td>
                ...
                <td colspan="6">
                    <div class="pagelist">
                        <s:if test="currentPage != 1">
                            <a href="comment_findComment.action?currentPage=<s:property value="1"/>">首页</a>
                            <a href="comment_findComment.action?currentPage=<s:property value="currentPage-1"/>">
                        ...
                        <s:if test="currentPage != pageSize">
                            ...
                            <a href="comment_findComment.action?currentPage=<s:property value="pageSize"/>">尾页</a>
                        </s:if>
...
<script type="text/javascript">
    ...
    function del(cmtId) {
        if (confirm("您确定要删除此评论吗?")) {
            ...
            document.getElementById("listform").action = "comment_deleteComment.action";
    ...
    function DelSelect() {
        ...
        if (Checkbox) {
            ...
            document.getElementById("listform").action = "comment_deleteMoreComment.action";
            document.getElementById("listform").submit();
        }
        else {
            alert("请选择您要删除的评论!");
